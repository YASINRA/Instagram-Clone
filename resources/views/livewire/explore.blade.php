    ...
    <ul class="grid grid-cols-3 sm:gap-3 ">
        ...
        @foreach ($posts as $post)
            ...
            <li onclick="Livewire.dispatch('openModal',{ component: 'post.view.modal', arguments:{'post':{{ $post->id }}}})"
                class="h-28 sm:h-80 w-full cursor cursor-pointer border rounded
              bg-black relative items-center flex justify-center group
                ">
                        ...
                        <span>
                            ...
                            <svg class="h-6 w-6" height="32" viewBox="0 0 32 32" width="32"
                                ...
                                <g fill="none" fill-rule="evenodd">
                                    ...
                                    <path
                                        d="m8 8v11.3333333c0 2.5057364 1.97487565 4.5502158 4.4530532 4.6618646l.2136135.0048021h11.3333333v4c0 2.209139-1.790861 4-4 4h-16c-2.209139 0-4-1.790861-4-4v-16c0-2.209139 1.790861-4 4-4zm21-8c1.6568542 0 3 1.34314575 3 3v16c0 1.6568542-1.3431458 3-3 3h-16c-1.6568542 0-3-1.3431458-3-3v-16c0-1.65685425 1.3431458-3 3-3z" fill="currentColor" />
                                </g>
                            </svg>
                        </span>
                    </div>
